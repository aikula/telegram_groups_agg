...
### 1️⃣ Добавьте бота в вашу группу

1. Откройте ваш Telegram-чат (группу или супергруппу)
2. Добавьте [@WhyVasyabot](https://t.me/WhyVasyabot)
3. **Обязательно:** Назначьте бота **администратором** с правами:
   - ✅ **Читать сообщения** (видеть всю историю чата)
   - ✅ **Писать сообщения** (отправлять ответы и сводки)
   - ⚠️ Без прав администратора бот не сможет читать сообщения в группе!

### 2️⃣ Войдите в веб-интерфейс

1. Напишите боту в личные сообщения команду `/login`
2. Бот отправит вам одноразовый пароль
3. Перейдите на [tghub.kulinich.ru](https://tghub.kulinich.ru)
4. Используйте полученный пароль для входа

### 3️⃣ Настройте бота (для владельцев и администраторов групп)

В веб-интерфейсе вы можете:
- 📊 Смотреть статистику сообщений и активности участников
- ⚙️ Настроить расписание автоматических сводок
- 🎭 Добавить описание характера вашей группы (для более точных ответов и рекомендаций)
- 📥 Экспортировать данные
- 🔔 Управлять уведомлениями

### 💬 Поддержка и обратная связь

- Telegram: [@aikula](https://t.me/aikula)
- Форма обратной связи в веб-интерфейсе

---

### 🔒 Безопасность данных

> **Дисклеймер:** Все сообщения хранятся в зашифрованном виде с использованием AES-256. Реализовано строгое разделение доступа между группами — администраторы видят только данные своих чатов.
>
> Если у вас повышенные требования к безопасности, вы можете [развернуть решение самостоятельно](https://github.com/aikula/telegram_groups_agg) на собственном сервере.
